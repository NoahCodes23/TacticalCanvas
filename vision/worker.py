...
from vision.gestures import HandTracker, paint_gestures, pinch_pointer
...
def draw_overlay(frame, calib, trackers, fps, hand_count, hand_px):
    ...
    for t in trackers.values():
        ...
        mode = (
            "ERASE" if t.erasing else
            "DRAW" if t.drawing else
            "GRAB" if t.grabbing else "open"
        )
